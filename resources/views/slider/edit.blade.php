            ...
            <div class="col-md-flex">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ url('home-slider') }}" class="btn btn-primary float-right">back</a>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('update-slider/'.$slider->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('uploads/slider/'.$slider->image) }}" width="100px"alt="">
                            </div>

                            <div class="form-group">
                                <label for="">Status</label>
                                <input type="checkbox" name="status"
                                value = "{{ $slider->status == '0' ? 'visible':'hidden'}}">
